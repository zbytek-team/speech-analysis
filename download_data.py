...
def main():
    ...
    parser.add_argument("--size", type=float, help="Total size of data to download in GB", required=True)
    ...
    for language in languages:
        ...
        try:
            ...
            preprocess_language_data(language, extract_path, args.save_path)
